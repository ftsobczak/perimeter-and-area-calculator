...
/**
 *
 * Class <code>TriangleTab</code> defines how the tab with calculations related to the triangle looks like.
...
public class TriangleTab extends JPanel {
    /**
     * This is the panel where is an image of a triangle.
     */
    ...
    /**
     * In this text field the value of the side A of the triangle is entered.
     */
    private JTextField dimensionA = new JTextField(7);
    /**
     * In this text field the value of the side B\high of the triangle is entered.
     */
     ...
     * In figurePanel is added an image of triangle.
     ...
     * At the bottom there is a similar group of JLabel and JTextField which is dedicated to value of side B\high of triangle.
    ...
    public TriangleTab()
    {
        ...
        JLabel img = new JLabel(new ImageIcon("Triangle.png"));
        figurePanel.add(img);
        ...
        JLabel bLength = new JLabel("Enter side B/height length: ");
                        ...
                        .addGroup(
                                equationPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING, true)
                                        ...
                                        .addGroup(equationPanelLayout.createSequentialGroup()
                                                .addComponent(aLength, 80,80,Short.MAX_VALUE)
                                                .addComponent(dimensionA))
                                        .addGroup(equationPanelLayout.createSequentialGroup()
                                                .addComponent(bLength, 80,80,Short.MAX_VALUE)
    ...
    private void getResult()
    {
        ...
        try
        {
            ...
            Figure triangle = new Triangle(sideA, sideB);
            resultPerimeter.setText("Perimeter = " + triangle.getPerimeter() + " cm2");
            resultArea.setText("Area = " + triangle.getArea() + " cm2");
            errorLabel.setText("");
        }
